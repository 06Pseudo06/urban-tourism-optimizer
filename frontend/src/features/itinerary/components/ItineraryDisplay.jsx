    ...
    <div className="relative pl-10 sm:pl-16 group flex flex-col pt-2 pb-6">
       ...
       {index > 0 && travelMins > 0 && (
         <div className="flex items-center gap-3 text-slate-500 mb-6 -ml-3">
           <div className="w-6 h-6 rounded-full bg-slate-100 border flex items-center justify-center relative z-10 left-[2px]">
              <ArrowDown size={14} />
           </div>
           <span className="text-sm font-semibold uppercase">{travelMins} min travel</span>
         </div>
       )}
       ...
       <div className="bg-white dark:bg-slate-900 rounded-2xl shadow-sm border border-slate-200/60 overflow-hidden hover:shadow-md hover:-translate-y-1 transition-all duration-300 ease-out flex flex-col sm:flex-row w-full max-w-4xl">
         ...
         <div className="sm:w-60 h-48 sm:h-auto shrink-0 relative overflow-hidden">
            ...
            <div className="absolute top-3 left-3 bg-white/90 rounded-lg px-3 py-1.5 flex items-center gap-2">
               <Clock size={14} />
         ...
         <div className="p-5 flex-1">
            <div className="mb-3">
              ...
              <div className="flex gap-2 flex-wrap"> 
                <span className="text-xs font-bold px-2 py-0.5 bg-slate-100 rounded uppercase">
                  {place.category || 'POI'}
                </span>
                <span className="text-xs font-bold px-2 py-0.5 rounded uppercase bg-blue-100">
                  {tagLabel}
                </span>
              </div>
            </div>
